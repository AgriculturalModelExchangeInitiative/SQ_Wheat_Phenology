...
void PhenologyComponent::Calculate_Model(PhenologyState& s, PhenologyState& s1, PhenologyRate& r, PhenologyAuxiliary& a, PhenologyExogenous& ex)
{
...
void PhenologyComponent::Init(PhenologyState& s, PhenologyState& s1, PhenologyRate& r, PhenologyAuxiliary& a, PhenologyExogenous& ex)
{
    s.calendarMoments.push_back("Sowing");
    s.calendarCumuls.push_back(0.0);
    s.calendarDates.push_back(sowingDate);
    s.minFinalNumber = 5.5;
}
