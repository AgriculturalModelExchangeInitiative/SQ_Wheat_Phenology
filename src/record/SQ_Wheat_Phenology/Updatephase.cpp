...
public:
    ...
    */
    virtual void compute(const vd::Time& /*time*/)
    {
        ...
        else if ( phase(-1) >= 1.0 && phase(-1) < 2.0)
        {
        ...
        else if ( phase(-1) >= 2.0 && phase(-1) < 4.0)
        {
        ...
        else if ( phase(-1) >= 5.0 && phase(-1) < 6.0)
        {
            localDegfm = degfm;
        ...
        else if ( phase(-1) >= 6.0 && phase(-1) < 7.0)
        {
            phase = phase(-1);
        }
    }
