...
void Updatecalendar::Calculate_Model(PhenologyState& s, PhenologyState& s1, PhenologyRate& r, PhenologyAuxiliary& a, PhenologyExogenous& ex)
{
    ...
    if (phase >= 1.0 && phase < 2.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "Emergence") != calendarMoments.end()))
    {
        calendarMoments.push_back("Emergence");
        calendarCumuls.push_back(cumulTT);
        calendarDates.push_back(currentdate);
    }
    else if ( phase >= 2.0 && phase < 3.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "FloralInitiation") != calendarMoments.end()))
    {
        calendarMoments.push_back("FloralInitiation");
        calendarCumuls.push_back(cumulTT);
        calendarDates.push_back(currentdate);
    }
    else if ( phase >= 3.0 && phase < 4.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "Heading") != calendarMoments.end()))
    {
        calendarMoments.push_back("Heading");
        calendarCumuls.push_back(cumulTT);
        calendarDates.push_back(currentdate);
    }
    else if ( phase == 4.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "Anthesis") != calendarMoments.end()))
    {
        calendarMoments.push_back("Anthesis");
        calendarCumuls.push_back(cumulTT);
        calendarDates.push_back(currentdate);
    }
    else if ( phase == 4.5 && !(find(calendarMoments.begin(), calendarMoments.end(), "EndCellDivision") != calendarMoments.end()))
    {
        calendarMoments.push_back("EndCellDivision");
        calendarCumuls.push_back(cumulTT);
        calendarDates.push_back(currentdate);
    }
    else if ( phase >= 5.0 && phase < 6.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "EndGrainFilling") != calendarMoments.end()))
    {
        calendarMoments.push_back("EndGrainFilling");
        calendarCumuls.push_back(cumulTT);
        calendarDates.push_back(currentdate);
    }
    else if ( phase >= 6.0 && phase < 7.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "Maturity") != calendarMoments.end()))
    {
