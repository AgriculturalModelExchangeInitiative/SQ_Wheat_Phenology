#ifndef _PHYLSOWINGDATECORRECTION_
...
void Phylsowingdatecorrection::Calculate_Model(PhenologyState& s, PhenologyState& s1, PhenologyRate& r, PhenologyAuxiliary& a, PhenologyExogenous& ex)
{
    ...
    if (latitude < 0.0)
    {
        ...
        {
            fixPhyll = p * (1 - (rp * min((sowingDay - sDsa_sh), double(sDws))));
        }
        else
        {
            fixPhyll = p;
