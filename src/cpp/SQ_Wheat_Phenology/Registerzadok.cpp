...
void Registerzadok::Calculate_Model(PhenologyState& s, PhenologyState& s1, PhenologyRate& r, PhenologyAuxiliary& a, PhenologyExogenous& ex)
{
    ...
    if (leafNumber >= 4.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "MainShootPlus1Tiller") != calendarMoments.end()))
    {
    ...
    else if ( leafNumber >= 5.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "MainShootPlus2Tiller") != calendarMoments.end()))
    {
    ...
    else if ( leafNumber >= 6.0 && !(find(calendarMoments.begin(), calendarMoments.end(), "MainShootPlus3Tiller") != calendarMoments.end()))
    {
    ...
    else if ( finalLeafNumber > 0.0 && (leafNumber >= slopeTSFLN * finalLeafNumber - intTSFLN && !(find(calendarMoments.begin(), calendarMoments.end(), "TerminalSpikelet") != calendarMoments.end())))
    {
    ...
    else if ( leafNumber >= roundedFinalLeafNumber - 4.0 && roundedFinalLeafNumber - 4 > 0 && !(find(calendarMoments.begin(), calendarMoments.end(), "PseudoStemErection") != calendarMoments.end()))
    {
    ...
    else if ( leafNumber >= roundedFinalLeafNumber - 3.0 && roundedFinalLeafNumber - 3 > 0 && !(find(calendarMoments.begin(), calendarMoments.end(), "1stNodeDetectable") != calendarMoments.end()))
    {
    ...
    else if ( leafNumber >= roundedFinalLeafNumber - 2.0 && roundedFinalLeafNumber - 2 > 0 && !(find(calendarMoments.begin(), calendarMoments.end(), "2ndNodeDetectable") != calendarMoments.end()))
    {
    ...
    else if ( leafNumber >= roundedFinalLeafNumber - 1.0 && roundedFinalLeafNumber - 1 > 0 && !(find(calendarMoments.begin(), calendarMoments.end(), "FlagLeafJustVisible") != calendarMoments.end()))
    {
    ...
    else if ( !(find(calendarMoments.begin(), calendarMoments.end(), "MidGrainFilling") != calendarMoments.end()) && (phase == 4.5 && cumulTTFromZC_65 >= der))
    {
