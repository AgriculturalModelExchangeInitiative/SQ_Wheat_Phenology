...
float Shootnumber::getsowingDensity() {return this-> sowingDensity; }
float Shootnumber::gettargetFertileShoot() {return this-> targetFertileShoot; }
void Shootnumber::setsowingDensity(float _sowingDensity) { this->sowingDensity = _sowingDensity; }
void Shootnumber::settargetFertileShoot(float _targetFertileShoot) { this->targetFertileShoot = _targetFertileShoot; }
void Shootnumber::Calculate_Model(PhenologyState& s, PhenologyState& s1, PhenologyRate& r, PhenologyAuxiliary& a)
{
    ...
    //                          ** max : 10000
    //                          ** unit : dimensionless
    float canopyShootNumber_t1 = s1.getcanopyShootNumber();
    float leafNumber = s.getleafNumber();
    vector<float> tilleringProfile_t1 = s1.gettilleringProfile();
    ...
    emergedLeaves = max(1, (int) ceil(leafNumber - 1.0f));
