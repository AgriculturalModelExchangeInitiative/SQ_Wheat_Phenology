...
{
    public class UpdatePhase : IStrategyPhenology
    {
        public UpdatePhase()
        {
            ...
            pd3.PropertyType = (Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(Phenology.DomainClass.PhenologyState);
            pd4.PropertyName = "isMomentRegistredZC_39";
            pd4.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
            _inputs0_0.Add(pd4);
            PropertyDescription pd5 = new PropertyDescription();
            pd5.DomainClassType = typeof(Phenology.DomainClass.PhenologyAuxiliary);
            pd5.PropertyName = "gAI";
            pd5.PropertyType = (Phenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI);
            _inputs0_0.Add(pd5);
            PropertyDescription pd6 = new PropertyDescription();
            pd6.DomainClassType = typeof(Phenology.DomainClass.PhenologyAuxiliary);
            pd6.PropertyName = "grainCumulTT";
            pd6.PropertyType = (Phenology.DomainClass.PhenologyAuxiliaryVarInfo.grainCumulTT).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.grainCumulTT);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(Phenology.DomainClass.PhenologyAuxiliary);
            pd7.PropertyName = "dayLength";
            pd7.PropertyType = (Phenology.DomainClass.PhenologyAuxiliaryVarInfo.dayLength).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.dayLength);
            _inputs0_0.Add(pd7);
            ...
            pd9.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.minFinalNumber).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.minFinalNumber);
            _inputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(Phenology.DomainClass.PhenologyAuxiliary);
            pd10.PropertyName = "fixPhyll";
            pd10.PropertyType = (Phenology.DomainClass.PhenologyAuxiliaryVarInfo.fixPhyll).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.fixPhyll);
            _inputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(Phenology.DomainClass.PhenologyState);
            pd11.PropertyName = "phase";
            pd11.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.phase).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.phase);
            _inputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(Phenology.DomainClass.PhenologyAuxiliary);
            pd12.PropertyName = "cumulTTFromZC_91";
            pd12.PropertyType = (Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_91).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_91);
            _inputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(Phenology.DomainClass.PhenologyState);
            pd13.PropertyName = "phyllochron";
            pd13.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.phyllochron).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.phyllochron);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(Phenology.DomainClass.PhenologyState);
            pd14.PropertyName = "hasLastPrimordiumAppeared";
            pd14.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
            _inputs0_0.Add(pd14);
            ...
            pd15.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
            _inputs0_0.Add(pd15);
            ...
            pd16.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
            ...
            pd17.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.phase).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.phase);
            ...
            pd18.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
        ...
        public string TestPostConditions(Phenology.DomainClass.PhenologyState s,Phenology.DomainClass.PhenologyState s1,Phenology.DomainClass.PhenologyRate r,Phenology.DomainClass.PhenologyAuxiliary a,Phenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r28 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
                if(r28.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber.ValueType)){prc.AddCondition(r28);}
                RangeBasedCondition r29 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.phase);
                if(r29.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.phase.ValueType)){prc.AddCondition(r29);}
                RangeBasedCondition r30 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
                if(r30.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared.ValueType)){prc.AddCondition(r30);}
        ...
        public string TestPreConditions(Phenology.DomainClass.PhenologyState s,Phenology.DomainClass.PhenologyState s1,Phenology.DomainClass.PhenologyRate r,Phenology.DomainClass.PhenologyAuxiliary a,Phenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39.CurrentValue=s.isMomentRegistredZC_39;
                ...
                RangeBasedCondition r3 = new RangeBasedCondition(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39);
                if(r3.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
                if(r4.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI);
                if(r5.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.grainCumulTT);
                if(r6.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyAuxiliaryVarInfo.grainCumulTT.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.dayLength);
                if(r7.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyAuxiliaryVarInfo.dayLength.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.vernaprog);
                if(r8.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.vernaprog.ValueType)){prc.AddCondition(r8);}
                RangeBasedCondition r9 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.minFinalNumber);
                if(r9.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.minFinalNumber.ValueType)){prc.AddCondition(r9);}
                RangeBasedCondition r10 = new RangeBasedCondition(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.fixPhyll);
                if(r10.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyAuxiliaryVarInfo.fixPhyll.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.phase);
                if(r11.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.phase.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_91);
                if(r12.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_91.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.phyllochron);
                if(r13.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.phyllochron.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
                if(r14.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
                if(r15.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber.ValueType)){prc.AddCondition(r15);}
