...
namespace Phenology.DomainClass
{
    public class PhenologyStateVarInfo : IVarInfoClass
    {
        ...
        static void DescribeVariables()
        {
            ...
            _calendarMoments.Description = "List containing appearance of each stage at previous day";
            _calendarMoments.MaxValue = ['Sowing'];
            _calendarMoments.MinValue = ['Sowing'];
            _calendarMoments.DefaultValue = ['Sowing'];
            ...
            _listGAITTWindowForPTQ.MaxValue = ;
            _listGAITTWindowForPTQ.MinValue = ;
            _listGAITTWindowForPTQ.DefaultValue = [0.0];
            ...
            _listPARTTWindowForPTQ.MaxValue = ;
            _listPARTTWindowForPTQ.MinValue = ;
            _listPARTTWindowForPTQ.DefaultValue = [0.0];
            ...
            _listTTShootWindowForPTQ1.MaxValue = ;
            _listTTShootWindowForPTQ1.MinValue = ;
            _listTTShootWindowForPTQ1.DefaultValue = [0.0];
            ...
            _listTTShootWindowForPTQ.MaxValue = ;
            _listTTShootWindowForPTQ.MinValue = ;
            _listTTShootWindowForPTQ.DefaultValue = [0.0];
            ...
            _calendarCumuls.Description = "list containing for each stage occured its cumulated thermal times at previous day";
            _calendarCumuls.MaxValue = [0.0];
            _calendarCumuls.MinValue = [0.0];
            _calendarCumuls.DefaultValue = [0.0];
            ...
            _currentZadokStage.Description = "current zadok stage";
            _currentZadokStage.MaxValue = ;
            _currentZadokStage.MinValue = ;
            _currentZadokStage.DefaultValue = "MainShootPlus1Tiller";
            ...
            _tilleringProfile.MaxValue = [288.0];
            _tilleringProfile.MinValue = [288.0];
            _tilleringProfile.DefaultValue = [288.0];
            ...
            _leafTillerNumberArray.MaxValue = [1, 1, 1];
            _leafTillerNumberArray.MinValue = [1, 1, 1];
            _leafTillerNumberArray.DefaultValue = [1, 1, 1];
