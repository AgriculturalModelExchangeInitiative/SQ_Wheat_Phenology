...
{
    public class IsMomentRegistredZC_39 : IStrategyPhenology
    {
        public IsMomentRegistredZC_39()
        {
            ...
            pd2.PropertyName = "isMomentRegistredZC_39";
            pd2.PropertyType = (Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
            _outputs0_0.Add(pd2);
        ...
        {
            get { return "if FlagLeafLiguleJustVisible is already Registred " ;}
        }
        ...
        public string TestPostConditions(Phenology.DomainClass.PhenologyState s,Phenology.DomainClass.PhenologyState s1,Phenology.DomainClass.PhenologyRate r,Phenology.DomainClass.PhenologyAuxiliary a,Phenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r2 = new RangeBasedCondition(Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
                if(r2.ApplicableVarInfoValueTypes.Contains( Phenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39.ValueType)){prc.AddCondition(r2);}
